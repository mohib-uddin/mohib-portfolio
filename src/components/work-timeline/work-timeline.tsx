...
const WorkTimeline=async ()=>{
   ...
   return(
       <div className={'mt-40 desktop:w-11/12 m-auto  mb-80 laptop:px-large__screen_container desktop:px-desktop__container large__desktop:px-large__screen_container'}>
